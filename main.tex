...
\author{Dr. John Doe}
\institute{Departament of Compt Science}
\date{Date}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
  \begin{column}{0.3\textwidth}
    \begin{center}
     \includegraphics[width=0.8\textwidth]{figures/xray.png}
     \end{center}
  \end{column}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{figures/chart.png}
    \caption{Caption}
\end{figure}
\end{frame}
...
\begin{columns}
  ...
  {\large \textcolor{hellblauMUW}{Headline for right column}}
    \begin{itemize}
	  \item Right column for content
	  \begin{itemize}
	  	\item Can contain text, charts, pictures, etc.
		\end{itemize}
	\end{itemize}
  \end{column}
\end{columns}
...
\begin{frame}{Source code}
    \begin{columns}
 	   \column{.50\textwidth}
	        \begin{block}{Python}
	        \vspace{-0.2cm}
		        a=2%\lstinputlisting{code/hello.py}
            \end{block}
 	   \column{.50\textwidth}
